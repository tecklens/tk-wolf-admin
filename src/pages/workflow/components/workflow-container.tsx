...
import WorkflowAllowDelete from "@/pages/workflow/components/allow-delete.tsx";
            ...
            <Dialog open={openSetting} onOpenChange={(val) => {
                ...
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <DialogFooter className={'flex justify-between w-full'}>
                        <Button type="button" variant={'destructive'} onClick={() => setOpenAllowDelete(true)}>Delete
                            Workflow</Button>
                        <Button type="submit" form={'modal-setting'}>Save changes</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
            <Dialog open={openAllowDelete} onOpenChange={(val) => {
                setOpenAllowDelete(val)
            }}>
                <WorkflowAllowDelete workflow={workflow} onClose={() => {
